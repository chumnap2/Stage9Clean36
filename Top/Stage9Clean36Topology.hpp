// ======================================================================
// \title  Stage9Clean36Topology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef STAGE9CLEAN36_STAGE9CLEAN36TOPOLOGY_HPP
#define STAGE9CLEAN36_STAGE9CLEAN36TOPOLOGY_HPP
// Included for access to Stage9Clean36::TopologyState and Stage9Clean36::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <Stage9Clean36/Top/Stage9Clean36TopologyDefs.hpp>

// Remove unnecessary Stage9Clean36:: qualifications
 ...
 * Stage9Clean36::TopologyState see: Stage9Clean36TopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Stage9Clean36::TopologyState see: Stage9Clean36TopologyDefs.hpp.
 *
