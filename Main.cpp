...
#include <Stage9Clean36/Top/Stage9Clean36Topology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    Stage9Clean36::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    Stage9Clean36::TopologyState inputs;
    ...
    Stage9Clean36::setupTopology(inputs);
    Stage9Clean36::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    Stage9Clean36::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
